        ...
        return `
            <div class="player-card">
                ...
                <div id="edit-${p.buyin_id}" class="edit-panel" style="display: none;">
                    ...
                    <div class="pot-buttons">
                        <button class="btn-chip" onclick="updateChipsReturned(${p.buyin_id}, -1)">-1 Pot</button>
                        <button class="btn-chip" onclick="updateChipsReturned(${p.buyin_id}, 1)">+1 Pot</button>
                    </div>
                </div>
            </div>
            ...
            <div class="history-card">
                <div class="history-header">
                    ...
                    <div class="history-actions">
                        <button class="history-btn" onclick="resumeGame(${game.id})">View</button>
                        <button class="history-btn delete" onclick="deleteGame(${game.id})">Delete</button>
                    </div>
                </div>
